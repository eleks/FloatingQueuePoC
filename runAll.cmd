set MASTER=net.tcp://localhost:11080$0$master
set SLAVE1=net.tcp://localhost:11081$1
set SLAVE2=net.tcp://localhost:11082$2
start FloatingQueue.Server\bin\Debug\FloatingQueue.Server.exe -pubport=10080 -intport=11080 -id=0 -m -nodes=%SLAVE1%;%SLAVE2%
