start FloatingQueueServer\bin\Debug\FloatingQueue.Server.exe -port=8080 -m -nodes=http://localhost:8081
start FloatingQueueServer\bin\Debug\FloatingQueue.Server.exe -port=8081 -nodes=http://localhost:8080$master
